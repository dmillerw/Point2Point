...
import static me.dmillerw.p2p.block.cable.BlockCable.CABLE_SIZE;
import static me.dmillerw.p2p.block.cable.BlockCable.CONNECTOR_DEPTH;
import static me.dmillerw.p2p.block.cable.BlockCable.CONNECTOR_SIZE;
...
public class CableBakedModel implements IBakedModel {
    ...
    private TextureAtlasSprite spriteCableEndOff;
    private TextureAtlasSprite spriteCableOn;
    private TextureAtlasSprite spriteCableEndOn;
    ...
    public CableBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        this.spriteCableEndOff = bakedTextureGetter.apply(new ResourceLocation(ModInfo.ID, "blocks/cable_end_off"));
        this.spriteCableOn = bakedTextureGetter.apply(new ResourceLocation(ModInfo.ID, "blocks/cable_on"));
        this.spriteCableEndOn = bakedTextureGetter.apply(new ResourceLocation(ModInfo.ID, "blocks/cable_end_on"));
    }
    ...
    public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
        ...
        Boolean connected = extendedBlockState.getValue(BlockCable.CONNECTED);

        final TextureAtlasSprite cable = connected ? spriteCableOn : spriteCableOff;
        final TextureAtlasSprite end = connected ? spriteCableEndOn : spriteCableEndOff;
