package me.dmillerw.p2p.client.model.loader;

import com.google.common.collect.Maps;
import me.dmillerw.p2p.client.model.cable.CableModel;
...
public class BaseModelLoader implements ICustomModelLoader {
    ...
    public boolean accepts(ResourceLocation modelLocation) {
        if (!modelLocation.getResourceDomain().equalsIgnoreCase(ModInfo.ID))
            return false;
