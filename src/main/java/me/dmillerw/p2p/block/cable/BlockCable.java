...
import me.dmillerw.p2p.lib.property.UnlistedBoolean;
import me.dmillerw.p2p.lib.property.UnlistedConnectionType;
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            if (cable != null) {
                ...
                TileCPU owner = cable.getNetworkCPU();
                if (owner != null) {
                    owner.analyzePath();
                }
            }
